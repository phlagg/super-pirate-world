...
class Player(pygame.sprite.Sprite):
    ...
    def move(self, dt):
        ...
        if self.jump:
            if self.on_surface['floor']:
                self.direction.y = -1 * self.jump_height
    ...
    def check_contact(self):
        ...
        # pygame.draw.rect(self.display_suface, 'yellow', floor_rect)
        # pygame.draw.rect(self.display_suface, 'yellow', right_rect)
        # pygame.draw.rect(self.display_suface, 'yellow', left_rect)
        ...
        self.on_surface['floor'] = (
            ...
            if (
                ...
                or floor_rect.collidelist(semi_collision_rects) >= 0
    ...
    def flicker(self):
        if self.timers['hit'].active and sin(pygame.time.get_ticks()/15) >= 0 :
