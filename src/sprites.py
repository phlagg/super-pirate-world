...
from settings import ANIMATION_SPEED, TILE_SIZE, Z_LAYERS
...
class Cloud(Sprite):
    def __init__(self, pos, surf, groups, speed, direction, z=Z_LAYERS['clouds']):
...
class Node(pygame.sprite.Sprite):
    def __init__(self, pos, surf, groups, level, data, paths) -> None:
        super().__init__(groups)
        self.image = surf
...
class PathSprite(Sprite):
    def __init__(self, pos, surf, groups, level) -> None:
